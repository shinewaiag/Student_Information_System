...
<div class="container">
    <div class="jumbotron jumbotron-fluid bg-dark m-0">
        ...
        <form action="search.php" method="post" id="navBarSearchForm" class="form-check-inline float-right">
        ...
        <div class="container">
            ...
            <table class="table table-primary">
                ...
                <tbody>
                <?php
                $query = "SELECT course_student.course_id,student.stdname,course_student.course_name,course_student.course_desc,course_student.enroll_date,course_student.course_id,course_student.user_id from student inner join course_student on student.user_id=course_student.user_id where course_student.status=0";
                ...
                <tr>
                    ...
                    <td><a href="confirmcourse.php?course_id=<?php echo $course_id?>&user_id=<?php echo $user_id?>" class="btn english btn-outline-success bdex" role="button" aria-pressed="true">Confirm</a></td>
                    <td><a href="cancelcourse.php?course_id=<?php echo $course_id?>&user_id=<?php echo $user_id?>" onclick="return confirm('Are you sure to cancel?');" class="btn english btn-outline-danger bdex" role="button" aria-pressed="true">Cancel</a></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
